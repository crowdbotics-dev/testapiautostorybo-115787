...
## Project Structure
    ...
    ├── testapiautostorybo_115787  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_115787`
...
2. Clone this repo and `cd testapiautostorybo_115787`
